...
dead_set = dead_df[dead_df["set"] == dead_df["set"].unique()]

bench_set["acc_r"].plot()

columns = "acc_r"
LowPass.low_pass_filter(bench_set, col=columns, sampling_frequency=fs, cutoff_frequency=0.4 , order=5)[columns + "_lowpass"].plot()
